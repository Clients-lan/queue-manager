...
//@Connect To Database
mongoose.connect(process.env.MONGOLAB_PURPLE_URI || 'mongodb+srv://flexyqnok:zzC40n9RWUNxwEEV@cluster0.gyzb2.mongodb.net/Cluster0?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
